...
public class HideableDialog extends AppCompatDialog
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        if (settings != null && hideSettingId > 0) settings.setBoolean(hideSettingId, b);
    }
    ...
    public static void ShowHidableDialog(
            Context context, int titleId, int msgId, int hideSettingId) {
