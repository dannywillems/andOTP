...
public final class ConfirmedPasswordTransformationHelper {
    ...
    /**
     * Sets up the specified password views for a toggleable obscure/view password text
     * transformation.
     */
    ...
    private static void dispatchPasswordVisibilityChange(
            EditText editText, boolean wasShowingPassword) {
        final int selection = editText.getSelectionEnd();
        PasswordTransformationMethod newMethod =
                wasShowingPassword ? null : PasswordTransformationMethod.getInstance();
